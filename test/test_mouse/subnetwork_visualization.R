    ...
    top_to <- head(sort(table(relationship$to), decreasing = TRUE), n = 10)
    top_from <- head(sort(table(relationship$from), decreasing = TRUE), n = 10)
    print(head(sort(table(relationship$to), decreasing = TRUE), n = 10))
    print(head(sort(table(relationship$from), decreasing = TRUE), n = 10))
