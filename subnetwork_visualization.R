    ...
    top_to <- head(sort(table(relationship$to), decreasing = TRUE), n = 1)
    top_from <- head(sort(table(relationship$from), decreasing = TRUE), n = 1)
    print(head(sort(table(relationship$to), decreasing = TRUE), n = 1))
    print(head(sort(table(relationship$from), decreasing = TRUE), n = 1))
